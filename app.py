...
1. Review full transcript — identify the weakest courses
1. Recommend course load reduction if total credits > 18
1. Refer to Student Support Services if attendance < 3.0
1. Notify Head of Department”””)
   elif pred==1:
   st.warning(”””**⚠️ Recommended Actions — Medium Risk**
1. Schedule a check-in within 2 weeks
1. Encourage attendance — target ≥ 3.5
1. Review assessment feedback with student
1. Monitor next semester — escalate if still declining”””)
   else:
